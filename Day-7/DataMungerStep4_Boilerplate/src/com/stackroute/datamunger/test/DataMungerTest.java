...
public class DataMungerTest {
  ...
  public void testRetrieveHeader() throws IOException {
    ...
    display(
      "successRetrieveHeaderTestCase",
      Arrays.toString(result.getHeaders())
    );
  }
  ...
  public void testRetrieveHeaderFailure() throws IOException {
    ...
    assertNotNull(
      "Headers are not matching with the included ipl.csv file of data folder in number or sequence",
      result.getHeaders()
    );
  ...
  public void testRetrieveDataTypes() throws IOException {
    ...
    display(
      "successRetrieveDataTypesTestCase",
      Arrays.toString(result.getDataTypes())
    );
  }
