...
public class QueryParser {
  ...
  public String getFileName(String queryString) {
    String tempFile = queryString.split("from")[1].trim();
    String strFileName = tempFile.split(" ")[0].trim();
    return strFileName;
  }
  ...
  public ArrayList<String> getGroupByFields(String queryString) {
    ...
    if (
      str.contains("where") &&
      (str.contains("group by")) &&
      str.contains("order by")
    ) {
  ...
  public String getBaseQuery(String queryString) {
    ...
    if (queryString.contains("where")) {
      ...
      queryString.contains("group by") || queryString.contains("order by")
    ) {
      strBaseQuery =
        queryString.toLowerCase().split("group by|order by")[0].trim();
    } else {
